...
export const PRICING_TABS: PriceTab[] = [
  {
    ...
    items: [
      ...
      { planId: "buyer_pro_monthly", title: "Buyer Pro", desc: "Unlimited reports, priority support & more.", price: "₹299", unit: "/month", offer: "or ₹1,999/year", cta: "subscribe" },
    ],
  },
  {
    key: "cp",
    ...
    items: [
      ...
      { planId: "cp_pro_monthly", title: "CP Pro", desc: "Everything, unlimited, with priority leads.", price: "₹999", unit: "/month", offer: "or ₹9,999/year", cta: "subscribe" },
    ],
  },
  {
    key: "developer",
    ...
    items: [
      ...
      { planId: "dev_pro_monthly", title: "Developer Pro", desc: "All tools, unlimited, top placement.", price: "₹9,999", unit: "/month", offer: "or ₹99,999/year", cta: "subscribe" },
    ],
  },
];
