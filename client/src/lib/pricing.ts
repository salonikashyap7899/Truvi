...
export const PRICING_TABS: PriceTab[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { planId: "dev_verified_badge", title: "Verified Developer Badge", desc: "Prime listing with the verified badge.", price: "₹4,999", cta: "buy" },
      { planId: "dev_3d_mapping", title: "3D Mapping", desc: "Interactive 3D master plan for your project.", price: "₹999", unit: "/project", cta: "buy" },
      { planId: "dev_crm", title: "Developer CRM", desc: "Manage leads and sales.", price: "₹499", unit: "/month", cta: "buy" },
      { planId: "dev_ai_analytics", title: "AI Analytics Dashboard", desc: "AI-powered project analytics.", price: "₹4,999", cta: "buy" },
      { planId: "dev_marketing_campaign", title: "Marketing Campaign", desc: "Full managed marketing campaign.", price: "₹2,00,000", cta: "buy" },
    ],
  },
];
