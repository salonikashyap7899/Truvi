...
import {
  ...
  ShieldCheck, Zap, ArrowRight, Sparkles, Pencil, FileText,
} from "lucide-react";
...
export default function DeveloperDashboardPage() {
  ...
  return (
    <main className="min-h-screen p-6 text-white md:p-10">
      ...
      {/* Bottom-corner developer guide — "why list on Truvi" pitch (downloadable). */}
      <a
        href="/brochure/Truvi-Developer-Onboarding.pdf"
        download
        title="Download the Truvi developer guide"
      ...
      >
        ...
        Why list on Truvi? — Developer Guide
