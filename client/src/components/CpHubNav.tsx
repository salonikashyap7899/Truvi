...
import { BarChart3, Bot, CalendarCheck2, FolderLock, GraduationCap, KanbanSquare, LayoutDashboard, Trophy, Users } from "lucide-react";
...
export function CpHubNav() {
  ...
  return (
    <nav className="mt-5 flex gap-2 overflow-x-auto pb-1" aria-label="CP hubs">
      {HUBS.map(({ to, label, icon: Icon, pro }) => {
